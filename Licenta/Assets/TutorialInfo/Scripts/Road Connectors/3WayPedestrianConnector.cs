...
public class ThreeWayPedestrianConnector : BaseRoadConnector
{
    ...
    [ContextMenu("Calculate Sockets for THIS 3-Way Pedestrian Road")]
    private void CalculateSockets()
    {
        ...
        Debug.Log("Calculated 3 sockets for 3Way-Pedestrian-Road.");
    }
}